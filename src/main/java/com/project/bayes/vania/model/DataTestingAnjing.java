...
@Entity(name = "data_testing_anjing")
public class DataTestingAnjing implements Serializable {
	...
	/**
	 * Compares the key for this instance with another DataTestingAnjing.
	 *
	 * @param other The object to compare to
	 * @return True if other object is instance of class DataTestingAnjing and the
	...
	private boolean equalKeys(Object other) {
		...
		if (!(other instanceof DataTestingAnjing)) {
			return false;
		}
		DataTestingAnjing that = (DataTestingAnjing) other;
	...
	/**
	 * Compares this instance with another DataTestingAnjing.
	 *
	 * @param other The object to compare to
	...
	public boolean equals(Object other) {
		if (!(other instanceof DataTestingAnjing))
			return false;
		return this.equalKeys(other) && ((DataTestingAnjing) other).equalKeys(this);
	}
	...
	public String toString() {
		return "DataTestingAnjing [id=" + id + ", jenisKelamin=" + jenisKelamin + ", gatalGatal=" + gatalGatal
