...
@Entity(name = "data_latih_anjing")
public class DataLatihAnjing implements Serializable {
	...
	private boolean equalKeys(Object other) {
		...
		if (!(other instanceof DataLatihAnjing)) {
			return false;
		}
		DataLatihAnjing that = (DataLatihAnjing) other;
	...
	public boolean equals(Object other) {
		if (!(other instanceof DataLatihAnjing))
			return false;
		return this.equalKeys(other) && ((DataLatihAnjing) other).equalKeys(this);
	}
	...
	public String toString() {
		return "DataLatihAnjing [id=" + id + ", jenisKelamin=" + jenisKelamin + ", gatalGatal=" + gatalGatal
